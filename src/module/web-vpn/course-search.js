...
module.exports = (query, request) => {
  ...
  return request({
    method: 'get',
    url: 'https://webvpn.hfut.edu.cn/http/77726476706e69737468656265737421faef469034247d1e760e9cb8d6502720ede479/eams5-student/for-std/lesson-search/semester/114/search/' + dataId,
    data: data,
